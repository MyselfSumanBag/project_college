...
import TravelImg from '../assets/travel-cover2.jpg'
	...
	return (
		<>
			<div className="min-h-[550px] bg-gray-100">
				<div className="min-h-[550px] flex justify-center items-center backdrop-blur-xl py-0 md:py-12 sm:py-0 ">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
							...
							<div data-aos="flip-up">
								<img
									src={TravelImg}
									alt="biryani img"
									className=" md:px-20 rounded-md h-[350px] w-full mx-auto drop-shadow-[5px_5px_12px_rgba(0,0,0,0.7)] object-cover"
								/>
							</div>
							{/* text content section */}
							<div className="flex flex-col justify-center gap-3 md:gap-6 px-4 lg:px-16">
								<h1
									data-aos="fade-up"
